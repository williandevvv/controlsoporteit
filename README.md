...
Aplicación web responsive/PWA para control de marcajes, personas y exportación Excel. Los datos se guardan en Firebase, no en `localStorage`.
...
2. Activa **Authentication → Email/Password** y **Cloud Firestore** (modo producción).
...
5. Publica las reglas: `firebase deploy --only firestore:rules`.
